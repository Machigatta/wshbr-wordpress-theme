...
$resObj = requestToTMDB($tmdb->type, $tmdb->id, "&append_to_response=credits&language=".$tmdb->language);
    ?>
    <hr>
    <div class="sidebar-block" style="margin-top: 0;padding-top: 0;">
        <div style="max-width: 100%;text-align: center;">
			<?php
                ...
                //echo '<h3><a href="/'.$type.'?id='.$resObj->id.'">'.$title.'</a></h3>';
                echo '<h3>'.$title.'</h3>';
			?>
            <img style="max-width: 100%;" src="<?php echo('https://image.tmdb.org/t/p/w300_and_h450_bestv2/'.$resObj->poster_path); ?>" alt="">
        </div>
        <hr>
        <?php 
            if ($resObj->overview != "") {
            ?>
                <div class="content_bringer">
                    <span class="sidebar-head">Handlung:</span>
